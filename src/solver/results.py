#This PSST file, originally due to Dheepak Krishnamurthy, has been modified by Swastik Sharma and Swathi Battula.
...
class PSSTResults(object):
    ...
    @property
    def IDSOCostNetowrk_dual(self):
        return self._get_Bus0('ActivePowerBalanceConstraint', self._model, dual=True)
